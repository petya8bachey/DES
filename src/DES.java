    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            if ("key".equals(command)) {
                ...
                byte[] cipher = des.crypt(message, key, command);

                FileOutputStream cipherFileOutputStream = new FileOutputStream(textFile);
                cipherFileOutputStream.write(cipher);
                cipherFileOutputStream.flush();
                cipherFileOutputStream.close();

                System.out.println("Please check text.txt for output!");
            }
