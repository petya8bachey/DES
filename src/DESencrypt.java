...
public class DESencrypt {
    ...
    public static void main(String[] args) {
        try {
            ...
            File cipherFile = new File("dtext.txt");
            ...
            if ("encrypt".equals(command)) {
                ...
                System.out.println("Encryption done! Please check dtext.txt for output!");
                ...
                System.out.println("Decryption done! Please check text.txt for output!");
